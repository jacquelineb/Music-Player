...
:doit
if /i "%1#" == "--libs#"    echo -LQ:/Program Files (x86)/taglib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IQ:/Program Files (x86)/taglib/include/taglib
if /i "%1#" == "--version#" echo 1.11
if /i "%1#" == "--prefix#"  echo Q:/Program Files (x86)/taglib
